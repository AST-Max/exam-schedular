  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-emerald-950 flex items-center justify-center p-4">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-emerald-400 rounded-full opacity-5 blur-3xl"></div>
      </div>
      ...
      <div className="relative bg-gray-800 bg-opacity-60 backdrop-blur-xl border border-gray-700 p-8 rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <p className="text-gray-400 mb-6 text-sm">Join Exam Scheduler today</p>
        ...
        {success && (
          <div className="bg-emerald-500 bg-opacity-10 border border-emerald-500 border-opacity-30 text-emerald-400 p-3 rounded-lg mb-4 text-sm">
            {success}
          </div>
        )}
